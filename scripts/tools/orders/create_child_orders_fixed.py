    ...
    for entry_order in entry_orders:
        ...
        if target_price and target_price > 0:
            try:
                ...
                print(f"  SUCCESS: TAKE_PROFIT created: ID {tp_order_id}, {tp_action} {tp_quantity} @ {target_price}")
                ...
                print(f"  ERROR: Could not create TAKE_PROFIT: {e}")
        ...
        if stop_loss and stop_loss > 0:
            try:
                ...
                print(f"  SUCCESS: STOP_LOSS created: ID {sl_order_id}, {sl_action} {sl_quantity} @ {stop_loss}")
                created_child_orders.append({
                    'parent_id': entry_id,
                ...
                print(f"  ERROR: Could not create STOP_LOSS: {e}")
